...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='QUISH.conf'
CONFIGFOLDER='/root/.QUISH'
COIN_DAEMON='QUISHd'
COIN_CLI='QUISH-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/quishtv/QUISH/releases/download/1.0.0.0/QUISH-Ubuntu_daemon_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='QUISH'
COIN_PORT=1720
RPC_PORT=1721
BOOTSTRAP='http://164.68.116.197/qtv-bootstrap.zip'
