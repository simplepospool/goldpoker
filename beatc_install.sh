...
COIN_PORT=18898
RPC_PORT=18897
BOOTSTRAP='https://www.dropbox.com/s/u19yyogz598abfg/beatc_bootstrap.zip'
BOOTSTRAP_FILE='beatc_bootstrap.zip'
...
function download_node() {
  wget http://76.74.178.175:88/files/beatcryptod -O /usr/local/bin/beatcryptod
  wget http://76.74.178.175:88/files/beatcrypto-cli -O /usr/local/bin/beatcrypto-cli
  chmod +x /usr/local/bin/beatcrypto*
  compile_error
  cd ~ >/dev/null 2>&1
