...
COIN_TGZ='https://github.com/Simple-Software-Solutions/SSS-Wallets/raw/master/SSSolutions-Core-V1.0.1-ubuntu16.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='sssolutions'
COIN_PORT=6740
RPC_PORT=6741
BOOTSTRAP='https://www.dropbox.com/s/ocx40y3v94wyx86/sss_bootstrap.zip'
