...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xvic.conf'
CONFIGFOLDER='/root/.xvic'
COIN_DAEMON='xvicd'
COIN_CLI='xvic-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/jhxzlqykq88unnh/xvic-1.0-linux-x64.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='xvic'
COIN_PORT=17500
RPC_PORT=17501
BOOTSTRAP='https://www.dropbox.com/s/9n14rbvxncqa9h7/xvic_bootstrap.zip'
