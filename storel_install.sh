...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='storel.conf'
CONFIGFOLDER='/root/.storelcore'
COIN_DAEMON='storeld'
COIN_CLI='storel-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/StorelPlatform/Storel-Platform/releases/download/v.1.0.0/storel-linux-nongui.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='storel'
COIN_PORT=7946
RPC_PORT=7947
BOOTSTRAP='https://www.dropbox.com/s/dshbd2y2peeciz4/storel_bootstrap.zip'
