...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tensorcoin.conf'
CONFIGFOLDER='/root/.tensorcoin'
COIN_DAEMON='tensorcoind'
COIN_CLI='tensorcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/tensor-services/TensorCoin/releases/download/1.0.0/tensorcoin-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='tensorcoin'
COIN_PORT=17774
RPC_PORT=17775
BOOTSTRAP='http://167.86.98.179/tnsr-bootstrap.zip'
