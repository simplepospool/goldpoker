...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='sharkcoin.conf'
CONFIGFOLDER='/root/.sharkcoin'
COIN_DAEMON='sharkcoind'
COIN_CLI='sharkcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/uiaethddm2sb4qc/sharkcoin341_daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='sharkcoin'
COIN_PORT=8322
RPC_PORT=8323
BOOTSTRAP='http://167.86.107.173/skn-bootstrap.zip'
