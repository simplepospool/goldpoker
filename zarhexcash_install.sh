...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zarhexcash.conf'
CONFIGFOLDER='/root/.zarhexcash'
COIN_DAEMON='zarhexcashd'
COIN_CLI='zarhexcash-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ProfProfcompile/zarhexcash/releases/download/v1.2.3.6/ZarhexcashLinuxV1.2.3.6ALL.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='zarhexcash'
COIN_PORT=40445
RPC_PORT=40446
BOOTSTRAP='http://164.68.119.61/zarh-bootstrap.zip'
...
#zarhexcash addnodes
addnode=51.38.71.12
addnode=51.75.170.189
addnode=51.75.162.92
addnode=51.75.162.95
