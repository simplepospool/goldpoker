...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='chvcash.conf'
CONFIGFOLDER='/root/.chvcash'
COIN_DAEMON='chvcashd'
COIN_CLI='chvcash-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://chvcash.com/releases/chvcash-linux-masternode1604.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='chvcash'
COIN_PORT=8184
RPC_PORT=8185
BOOTSTRAP='https://www.dropbox.com/s/x1o4m57bvcye4np/cvhc_bootstrap.zip'
...
addnode=134.209.254.94:8184
addnode=136.144.171.201:8184
addnode=165.22.72.22:8184
addnode=134.209.245.200:8184
addnode=134.209.243.172:8184
addnode=134.209.247.177:8184
addnode=157.230.118.163:8184
addnode=134.209.247.69:8184
EOF
}
