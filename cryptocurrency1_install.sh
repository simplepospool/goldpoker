...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cryptocurrency.conf'
CONFIGFOLDER='/root/.cryptocurrency'
COIN_DAEMON='cryptocurrencyd'
COIN_CLI='cryptocurrency-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CCYofficial/CCY/releases/download/1.1.0.0/cryptocurrency.ubuntu16.04.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='cryptocurrency'
COIN_PORT=5535
RPC_PORT=5536
BOOTSTRAP='http://164.68.119.61/ccy-bootstrap.zip'
