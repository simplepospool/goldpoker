...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='insurance.conf'
CONFIGFOLDER='/root/.insurance'
COIN_DAEMON='insuranced'
COIN_CLI='insurance-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/globalcointeam/Insurance/releases/download/V1.1/ubuntu-1604.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='insurance'
COIN_PORT=22150
RPC_PORT=22151
BOOTSTRAP='https://www.dropbox.com/s/ciqks2vppbrjaaa/sec_bootstrap.zip'
