...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='chtc.conf'
CONFIGFOLDER='/root/.chtc'
COIN_DAEMON='chtcd'
COIN_CLI='chtc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CryptoHashTank/CHTC/releases/download/v1.0.3/chtc-1.0.3-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='chtc'
COIN_PORT=6969
RPC_PORT=6970
BOOTSTRAP='https://github.com/CryptoHashTank/CHTC/releases/download/Bootstrap/CHTC.zip'
