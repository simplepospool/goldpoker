...
CONFIGFOLDER='/root/.syndicate'
COIN_DAEMON='syndicated'
COIN_CLI='syndicate-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/SyndicateLtd/SyndicateQt/releases/download/x2.1.0/Syndicate-2.1.0-linux64.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='syndicate'
COIN_PORT=25992
RPC_PORT=25993
BOOTSTRAP='https://www.dropbox.com/s/2vrw5g2n30y2nmx/synx_bootstrap.zip'
