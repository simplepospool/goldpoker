...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Openbit.conf'
CONFIGFOLDER='/root/.Openbit'
COIN_DAEMON='Openbitd'
COIN_CLI='Openbit-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/openbitteam/Openbit/releases/download/Wallets/openbit-linux.tgz'
...
addnode=node1.Openbitcoin.com
addnode=node2.Openbitcoin.com
EOF
}
