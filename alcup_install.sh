...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='alphacup.conf'
CONFIGFOLDER='/root/.alphacup'
COIN_DAEMON='alphacupd'
COIN_CLI='alphacup-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://alphacup.io/alphacup-1.1.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='alphacup'
COIN_PORT=13111
RPC_PORT=13112
BOOTSTRAP='https://www.dropbox.com/s/ibfuj33d9zb1qi0/alcup_bootstrap.zip'
