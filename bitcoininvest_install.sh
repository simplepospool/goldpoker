...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitcoininvest.conf'
CONFIGFOLDER='/root/.bitcoininvest'
COIN_DAEMON='bitcoininvestd'
COIN_CLI='bitcoininvest-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/ente8q3p2hs4cmx/bitcoininvest.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='bitcoininvest'
COIN_PORT=23750
RPC_PORT=23751
BOOTSTRAP='https://www.dropbox.com/s/no2q7l5lscm0i46/btv_bootstrap.zip'
