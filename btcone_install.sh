...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitcoinone.conf'
CONFIGFOLDER='/root/.bitcoinone'
COIN_DAEMON='bitcoinoned'
COIN_CLI='bitcoinone-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BitCoinONE1/BTCONE-Blockchain/releases/download/v3.1.100/bitcoinone-x86_64-linux-gnu.tar.gz'
