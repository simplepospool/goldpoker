...
COIN_TGZ='https://github.com/SPECTRUMX-SPE/SpectrumxMN/releases/download/v1/spectrumxbin.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='spectrumx'
COIN_PORT=34441
RPC_PORT=34442
BOOTSTRAP='https://www.dropbox.com/s/e6dyvbyjfy4pf97/spe_bootstrap.zip'
