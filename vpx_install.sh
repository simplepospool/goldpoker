...
COIN_TGZ='https://github.com/privix/privix-core/releases/download/v1.0.0.1/privix-1.0.0.1-node.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='privix'
COIN_PORT=7788
RPC_PORT=7789
BOOTSTRAP='https://www.dropbox.com/s/oi1fmwf7zy4h8pg/vpx_bootstrap.zip'
