...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='highstakes.conf'
CONFIGFOLDER='/root/.highstakes'
COIN_DAEMON='highstakesd'
COIN_CLI='highstakes-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/HighStakesCoin/HighStakes/releases/download/v1.0.0.0/Highstakes-1.0.0.0-daemon-ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='highstakes'
COIN_PORT=12319
RPC_PORT=12320
BOOTSTRAP='https://www.dropbox.com/s/voxndjlfyxwv2kt/hisc_bootstrap.zip'
