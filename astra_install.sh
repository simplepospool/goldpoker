...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='Astracoin.conf'
CONFIGFOLDER='/root/.Astracoin'
COIN_DAEMON='Astracoind'
COIN_CLI='Astracoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CryptoLover705/astra-wallets/releases/download/1.0.0.2/astralinux16.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Astracoin'
COIN_PORT=4143
RPC_PORT=4144
BOOTSTRAP='http://164.68.116.197/tr3b-bootstrap.zip'
