...
CONFIGFOLDER='/root/.safeinsure'
COIN_DAEMON='safeinsured'
COIN_CLI='safeinsure-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/SafeInsure/sins-coin/releases/download/v1.0.0.11/safeinsure-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='safeinsure'
COIN_PORT=39105
RPC_PORT=39106
BOOTSTRAP='http://164.68.119.61/sins-bootstrap.zip'
