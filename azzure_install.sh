...
COIN_TGZ='https://github.com/CryptoCoderz/Azzure/releases/download/v1.0.0.3/Azzure-daemon-v1.0.0.3-Ubuntu_x64.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Azzure'
COIN_PORT=22115
RPC_PORT=22116
BOOTSTRAP='http://167.86.107.173/azzr-bootstrap.zip'
