...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='gpkr.conf'
CONFIGFOLDER='/root/.gpkr'
COIN_DAEMON='gpkrd'
COIN_CLI='gpkr-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/GoldPoker/GoldPoker-coin/releases/download/GoldPoker_1.0.0.2/gpkr_linux_1.0.0.2.zip'
COIN_NAME='GoldPoker'
COIN_PORT=33303
RPC_PORT=18822
