...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='energi.conf'
CONFIGFOLDER='/root/.energicore'
COIN_DAEMON='energid'
COIN_CLI='energi-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/energicryptocurrency/energi/releases/download/v2.2.1/energicore-2.2.1-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='energi'
COIN_PORT=9797
RPC_PORT=9798
BOOTSTRAP='http://164.68.112.107/nrg-bootstrap.zip'
BOOTSTRAP_FILE=$(echo $BOOTSTRAP | awk -F'/' '{print $NF}')
SENTINEL_REPO='https://github.com/energicryptocurrency/sentinel.git'
