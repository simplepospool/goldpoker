...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='dexergi.conf'
CONFIGFOLDER='/root/.dexergi'
COIN_DAEMON='dexergid'
COIN_CLI='dexergi-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/dexergiproject/dexergi/releases/download/v1.2.0/dexergi-1.2.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='dexergi'
COIN_PORT=5536
RPC_PORT=5537
BOOTSTRAP='http://164.68.119.61/dexr-bootstrap.zip'
