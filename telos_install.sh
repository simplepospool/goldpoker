...
COIN_TGZ='https://github.com/phoenixkonsole/transcendence/releases/download/v2.0.0.1/Linux.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='transcendence'
COIN_PORT=8051
RPC_PORT=8052
BOOTSTRAP='https://github.com/phoenixkonsole/transcendence/releases/download/v2.0.0.1/Bootstrap.zip'
