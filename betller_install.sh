...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='betller.conf'
CONFIGFOLDER='/root/.betller'
COIN_DAEMON='betllerd'
COIN_CLI='betller-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/apqv6otnd2q6lwc/betller_v130_ubu16.tar.gz'
