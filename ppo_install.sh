...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ppo.conf'
CONFIGFOLDER='/root/.ppo'
COIN_DAEMON='ppod'
COIN_CLI='ppo-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/picpoto/picpotocoin/releases/download/v1.0/picpoto-linux.zip'
COIN_NAME='PPO'
COIN_PORT=36001
RPC_PORT=36002
...
function download_node() {
  ...
  compile_error
  apt install unzip
  unzip -j $COIN_TGZ --show-progress
    compile_error
  rm $COIN_TGZ
  sleep 5
  chmod +x $COIN_DAEMON
