...
COIN_TGZ='https://github.com/RapidsOfficial/Rapids/releases/download/v1.0.0.1/rapids-linux-64.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='rapids'
COIN_PORT=28732
RPC_PORT=28733
BOOTSTRAP='https://www.dropbox.com/s/mgxbl74312n2aku/rapids_bootstrap.zip'
