...
COIN_TGZ='https://github.com/RapidsOfficial/Rapids/releases/download/v2.0.0.0-b784ecbf4d/rapids-v2.0.0.0-b784ecbf4d-lin64.tgz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='rapids'
COIN_PORT=28732
RPC_PORT=28733
BOOTSTRAP='http://164.68.119.61/rpd-bootstrap.zip'
