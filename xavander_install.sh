...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xavander.conf'
CONFIGFOLDER='/root/.xavander'
COIN_DAEMON='xavanderd'
COIN_CLI='xavander-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/a9etjmbsvhaohx9/xavander_v12_ubu16.tar.gz'
