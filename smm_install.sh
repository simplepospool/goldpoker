...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='smm.conf'
CONFIGFOLDER='/root/.smm'
COIN_DAEMON='smmd'
COIN_CLI='smm-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/SMMCoreDev/smm_core/releases/download/v1.0.0/smm-core-1.0.0-linux-daemon.tgz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='smm'
COIN_PORT=18100
RPC_PORT=18101
BOOTSTRAP='https://www.dropbox.com/s/yseyj1oonzujvdw/smm_bootstrap.zip'
