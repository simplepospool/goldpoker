...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cryptoinvest.conf'
CONFIGFOLDER='/root/.cryptoinvest'
COIN_DAEMON='cryptoinvestd'
COIN_CLI='cryptoinvest-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CTTDeveloperTeam/CTTCoin/releases/download/v1.0/CryptoInvest-1.0.0-x86_64-pc-linux-gnu.zip'
COIN_TGZ_FILE='CryptoInvest-1.0.0-x86_64-pc-linux-gnu.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='cryptoinvest'
COIN_PORT=57810
RPC_PORT=57811
BOOTSTRAP='https://www.dropbox.com/s/i2ihq42871clof7/ctt_bootstrap.zip'
BOOTSTRAP_FILE='ctt_bootstrap.zip'
