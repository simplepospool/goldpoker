...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='delirium.conf'
CONFIGFOLDER='/root/.delirium'
COIN_DAEMON='deliriumd'
COIN_CLI='delirium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ATONJPZ7S7/delirium/releases/download/1.0.1.2/daemon-linux-1.0.1.2.tar.gz'
...
addnode=sed1.delirium.cf
addnode=sed2.delirium.cf
addnode=sed3.delirium.cf
addnode=sed4.delirium.cf
addnode=sed5.delirium.cf
addnode=sed6.delirium.cf
addnode=sed7.delirium.cf
addnode=sed8.delirium.cf
