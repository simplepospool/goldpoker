...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xgamingup.conf'
CONFIGFOLDER='/root/.xgamingup'
COIN_DAEMON='xgamingupd'
COIN_CLI='xgamingup-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/XgamingUP/XgamingUP/releases/download/v1.0.2.0/xgamingup-1.0.2.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='xgamingup'
COIN_PORT=17140
RPC_PORT=17141
BOOTSTRAP='https://www.dropbox.com/s/drrruwcvu99k7vt/xga_bootstrap.zip'
