...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitwin24.conf'
CONFIGFOLDER='/root/.bitwin24'
COIN_DAEMON='bitwin24d'
COIN_CLI='bitwin24-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BitWin24/bitwin24/releases/download/v0.0.9/bitwin24-0.0.9-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='bitwin24'
COIN_PORT=24072
RPC_PORT=24073
BOOTSTRAP='http://164.68.116.197/bwi-bootstrap.zip'
