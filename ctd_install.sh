...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ctdcoin.conf'
CONFIGFOLDER='/root/.ctdcoin'
COIN_DAEMON='ctdcoind'
COIN_CLI='ctdcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/cryptotradingcoin/project-CTD/releases/download/v0.11/CTD_v0.11_linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='ctdcoin'
COIN_PORT=33263
RPC_PORT=33264
BOOTSTRAP='https://www.dropbox.com/s/5hzcci9l9tsptmf/ctd_bootstrap.zip'
