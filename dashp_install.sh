...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='dashplatinum.conf'
CONFIGFOLDER='/root/.dashplatinum'
COIN_DAEMON='dashplatinumd'
COIN_CLI='dashplatinum-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/dashplatinum-org/dashplatinum/releases/download/V2.1.1.1/dashplatinum-linux-daemon-2.1.1.tar.gz'
