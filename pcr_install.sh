...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='paycore.conf'
CONFIGFOLDER='/root/.paycore'
COIN_DAEMON='paycored'
COIN_CLI='paycore-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/PayCoreProject/PayCore/releases/download/1.2.2a/daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='paycore'
COIN_PORT=17317
RPC_PORT=17318
BOOTSTRAP='https://www.dropbox.com/s/3dk0xj0jut29946/pcr_bootstrap.zip'
