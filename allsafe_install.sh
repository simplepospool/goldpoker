...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='allsafe.conf'
CONFIGFOLDER='/root/.allsafe'
COIN_DAEMON='allsafed'
COIN_CLI='allsafe-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Artinvest/Allsafe/releases/download/initial/safe-daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='allsafe'
COIN_PORT=7127
RPC_PORT=7128
BOOTSTRAP='http://164.68.116.197/safe-bootstrap.zip'
