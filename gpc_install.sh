...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='GreenPayCoin.conf'
CONFIGFOLDER='/root/.GreenPayCoin'
COIN_DAEMON='GreenPayCoind'
COIN_CLI='GreenPayCoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/tf5e28x4p9nsxq0/gpc.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='GreenPayCoin'
COIN_PORT=29721
RPC_PORT=29722
BOOTSTRAP='https://www.dropbox.com/s/sh5ujjubuu3vq2r/gpc_bootstrap.zip'
...
#GreenPayCoin addnodes
addnode=149.28.146.108
addnode=149.28.36.165
addnode=108.61.149.206
addnode=149.28.229.20
addnode=149.28.57.82
addnode=149.28.63.223
EOF
}
