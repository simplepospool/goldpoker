...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ghrcoin.conf'
CONFIGFOLDER='/root/.ghrcoin'
COIN_DAEMON='ghrcoind'
COIN_CLI='ghrcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/GHRcoin/GHRCoin/releases/download/v1.0.0.0/GHRCoin-1.0.0.0-daemon-ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='ghrcoin'
COIN_PORT=23121
RPC_PORT=23122
BOOTSTRAP='https://www.dropbox.com/s/pu22gmubw0ivman/ghr_bootstrap.zip'
...
#GHR addnodes
addnode=68.183.23.187
addnode=138.68.11.190
addnode=178.62.251.147
addnode=178.128.53.151
addnode=178.62.33.92
addnode=104.248.20.91
addnode=159.203.41.87
addnode=139.59.12.75
