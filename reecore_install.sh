...
COIN_TGZ='https://github.com/reecore-coin/Reex/releases/download/v.1.3.1.0/Reecore-v1.3.1.0-linux-ubuntu16.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='reecore'
COIN_PORT=43210
RPC_PORT=43211
BOOTSTRAP='http://164.68.116.197/reex-bootstrap.zip'
