...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='chancebet.conf'
CONFIGFOLDER='/root/.chancebet'
COIN_DAEMON='chancebetd'
COIN_CLI='chancebet-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CHANCEBETCOIN/Chancebet/releases/download/v1.0.0.0/Chancebet-1.0.0.0-daemon_ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='chancebet'
COIN_PORT=2312
RPC_PORT=2313
BOOTSTRAP='https://www.dropbox.com/s/r1fqvpsxytq8vm7/chanc_bootstrap.zip'
...
#chancebet addnodes
addnode=165.227.30.77
addnode=167.99.204.71
addnode=167.99.94.210
addnode=167.99.94.65
addnode=167.99.91.111
addnode=167.99.87.213
addnode=167.99.200.68
addnode=167.99.196.193
EOF
}
