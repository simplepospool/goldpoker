...
COIN_TGZ='https://github.com/NixPlatform/NixCore/releases/download/v3.0.4/nix-3.0.4-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='nix'
COIN_PORT=6215
RPC_PORT=6214
BOOTSTRAP='https://www.dropbox.com/s/jc9oofpt1ol26uz/nix_bootstrap.zip'
# http://164.68.112.107/nix-bootstrap.zip'
...
function create_key() {
  ...
  COINKEY=$(try_cmd $COIN_PATH$COIN_CLI "createmasternodekey" "ghostnode genkey")
  if [ "$?" -gt "0" ];
    then
