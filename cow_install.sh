...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cowry.conf'
CONFIGFOLDER='/root/.cowry'
COIN_DAEMON='cowryd'
COIN_CLI='cowry-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/moneycowry/cowry/releases/download/1.0.0.0/cowry.ubuntu16.04.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='cowry'
COIN_PORT=6626
RPC_PORT=6627
BOOTSTRAP='https://www.dropbox.com/s/zv8kowfagiewwyl/cow_bootstrap.zip'
