...
COIN_TGZ='https://github.com/didarmetu/New808coin/releases/download/v4.1.1.0-GA/new808coin-v4.1.1.0-x86_64-ubuntu16-gnu.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='new808coin'
COIN_PORT=33808
RPC_PORT=33809
BOOTSTRAP='http://164.68.116.197/n808-bootstrap.zip'
