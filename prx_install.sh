...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='prx.conf'
CONFIGFOLDER='/root/.prx'
COIN_DAEMON='prxd'
COIN_CLI='prx-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ProxyNode/proxynode/releases/download/v2.0.0/Proxynode-Linux-MN-v2.0.0.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='prx'
COIN_PORT=12195
RPC_PORT=12194
BOOTSTRAP='https://www.dropbox.com/s/t0tjvldjmb1v0su/prx_bootstrap.zip'
...
addnode=104.248.159.84
addnode=104.248.116.47
addnode=142.93.32.240
addnode=178.128.226.95
addnode=142.93.162.83
EOF
}
