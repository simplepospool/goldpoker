...
COIN_TGZ='https://github.com/dachcoin/dach/releases/download/v1.0.1.1/dach-1.0.1.1-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='dach'
COIN_PORT=31654
RPC_PORT=31655
BOOTSTRAP='https://www.dropbox.com/s/neht93qc1uncl4k/dachx_bootstrap.zip'
