...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='npccoin.conf'
CONFIGFOLDER='/root/.npccoin'
COIN_DAEMON='npccoind'
COIN_CLI='npccoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/npccoin/npccoin/releases/download/v2.0.2/npccoin-2.0.2-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='npccoin'
COIN_PORT=7168
RPC_PORT=7167
BOOTSTRAP='https://www.dropbox.com/s/4wisofvkfff0bfj/npc_bootstrap.zip'
