...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='cryptoverification.conf'
CONFIGFOLDER='/root/.cryptoverification'
...
COIN_PORT=1316
RPC_PORT=1317
BOOTSTRAP='https://github.com/CVCCVerifyCoin/Cryptoverification/releases/download/v1.1.0.0/bootstrap.zip'
