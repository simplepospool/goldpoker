...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bitcoin2.conf'
CONFIGFOLDER='/root/.bitcoin2'
COIN_DAEMON='bitcoin2d'
COIN_CLI='bitcoin2-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/BITC2/bitcoin2/releases/download/2.2.1/bitcoin2-2.2.1-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='bitcoin2'
COIN_PORT=8333
RPC_PORT=8334
BOOTSTRAP='https://www.dropbox.com/s/8c3hqhod3c57wny/btc2_bootstrap.zip'
