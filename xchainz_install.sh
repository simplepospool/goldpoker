...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xchainz.conf'
CONFIGFOLDER='/root/.xchainz'
COIN_DAEMON='xchainzd'
COIN_CLI='xchainz-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/axanthics/xcz/releases/download/v1.0.0/XChainZd-Ubuntu-16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='xchainz'
COIN_PORT=14815
RPC_PORT=14816
BOOTSTRAP='https://github.com/axanthics/xcz/releases/download/v1.0.0/bootstrap.zip'
