...
COIN_TGZ='https://github.com/BlockchainFor/ESBC2/releases/download/2.1.0.1/esbc-daemon-linux-x86_64-static.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='esbcoin'
COIN_PORT=32322
RPC_PORT=32323
BOOTSTRAP='https://www.dropbox.com/s/6l0zacvyi8z8ur3/esbc_bootstrap.zip'
