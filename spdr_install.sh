...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='spdr.conf'
CONFIGFOLDER='/root/.spdr'
COIN_DAEMON='spdrd'
COIN_CLI='spdr-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/SPDR-Core/spdr/releases/download/1.1.1.0/Spider-Ubuntu_Daemon.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='spdr'
COIN_PORT=53617
RPC_PORT=53618
BOOTSTRAP='https://www.dropbox.com/s/ffiedlp42jmdb7e/spdr_bootstrap.zip'
...
function download_bootstrap() {
  ...
  rm -rf $CONFIGFOLDER/stateSpider >/dev/null 2>&1
