...
CONFIGFOLDER='/root/.ONEX'
COIN_DAEMON='onexd'
COIN_CLI='onex-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/oneexbit/onex-core/releases/download/v2.2.1/onex-2.2.1-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='onex'
COIN_PORT=30229
RPC_PORT=30228
BOOTSTRAP='https://www.dropbox.com/s/7pdum5gqy991v9g/onex_bootstrap.zip'
...
addnode=node1.oneexbit.com
addnode=node2.oneexbit.com
addnode=node3.oneexbit.com
addnode=node4.oneexbit.com
addnode=node5.oneexbit.com
addnode=node6.oneexbit.com
addnode=node7.oneexbit.com
addnode=node8.oneexbit.com
addnode=node9.oneexbit.com
addnode=node10.oneexbit.com
