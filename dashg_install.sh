...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='dashgreen.conf'
CONFIGFOLDER='/root/.dashgreen'
COIN_DAEMON='dashgreend'
COIN_CLI='dashgreen-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/DashGreenCoin/dashgreen/releases/download/v1.0/dashgreen-daemon.zip'
