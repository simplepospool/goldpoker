...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='harcomia.conf'
CONFIGFOLDER='/root/.harcomia'
COIN_DAEMON='harcomiad'
COIN_CLI='harcomia-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/evbx7q3suw089kh/harcomia.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='harcomia'
COIN_PORT=13123
RPC_PORT=13124
BOOTSTRAP='https://www.dropbox.com/s/r9yq0g8g6i9kkih/hca_bootstrap.zip'
