...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='versess.conf'
CONFIGFOLDER='/root/.versess'
COIN_DAEMON='versessd'
COIN_CLI='versess-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/VersessCTO/versess-core/releases/download/v1.0/VERS-v1.0-daemon-ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='versess'
COIN_PORT=13811
RPC_PORT=13812
BOOTSTRAP='https://github.com/VersessCTO/versess-core/releases/download/v1.0/bootstrap.zip'
