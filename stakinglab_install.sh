...
CONFIGFOLDER='/root/.labx'
COIN_DAEMON='labxd'
COIN_CLI='labx-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/StakingLab/stakinglab-coin/releases/download/v1.0.5/labx-1.0.5-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='labx'
COIN_PORT=33330
RPC_PORT=33331
BOOTSTRAP='http://164.68.112.107/labx-bootstrap.zip'
