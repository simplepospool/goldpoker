...
COIN_DAEMON='streamitcoind'
COIN_CLI='streamitcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/StreamitCoin/StreamitCoin/releases/download/v1.0.0.0/streamitcoin-1.0.0-x86_64-linux-gnu.tar.gz'
