...
COIN_TGZ='https://github.com/VulcanoCrypto/Vulcano/releases/download/2.1.0.0/Vulcano-2.1.0.0-x86_64-linux64-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Vulcano'
COIN_PORT=62543
RPC_PORT=62542
BOOTSTRAP='http://164.68.119.61/vulc-bootstrap.zip'
