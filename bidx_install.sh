...
COIN_TGZ='https://github.com/bidxcore/bidx/releases/download/v0.17.1.0-0316270f2/bidx-linux-daemon.tgz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='bidx'
COIN_PORT=40000
RPC_PORT=40001
BOOTSTRAP='https://www.dropbox.com/s/hrqu2io617sabte/bidx_bootstrap.zip'
