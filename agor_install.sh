...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='agora.conf'
CONFIGFOLDER='/root/.agora'
COIN_DAEMON='agorad'
COIN_CLI='agora-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AGORACoinDeveloper/AGORACoin/releases/download/v1.0.0.0/Agora-1.0.0.0-daemon-ubuntu_16.04.tar.gz'
...
#agora addnodes
addnode=165.22.198.120
addnode=167.71.166.148
addnode=167.71.166.246
addnode=167.71.166.87
addnode=138.197.108.43
addnode=165.227.121.177
addnode=167.71.166.105
addnode=165.227.117.245
