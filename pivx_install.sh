...
COIN_TGZ='https://github.com/PIVX-Project/PIVX/releases/download/v4.1.0/pivx-4.1.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='pivx'
COIN_PORT=51472
RPC_PORT=51473
BOOTSTRAP='http://164.68.112.107/pivx-bootstrap.zip'
