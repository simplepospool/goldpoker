...
COIN_TGZ='https://github.com/PIVX-Project/PIVX/releases/download/v3.2.2/pivx-3.2.2-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='pivx'
COIN_PORT=51472
RPC_PORT=51473
BOOTSTRAP='https://www.dropbox.com/s/j0dw6w2bgg6ey1e/pivx_bootstrap.zip'
