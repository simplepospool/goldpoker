...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='escortcoin.conf'
CONFIGFOLDER='/root/.escortcoin'
COIN_DAEMON='escortcoind'
COIN_CLI='escortcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/escortcrypto/EscortCoin/releases/download/1.0.0/escortcoin-1.0.0-x86_64-linux-gnu.tar.gz'
