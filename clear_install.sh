...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='clr.conf'
CONFIGFOLDER='/root/.clr'
COIN_DAEMON='clrd'
COIN_CLI='clr-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/ClearNode/Clearcore-Project/releases/download/v1.1.0/ClearCoin-Linux-Daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='clear'
COIN_PORT=32628
RPC_PORT=32629
BOOTSTRAP='http://164.68.119.61/clr-bootstrap.zip'
