...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bws.conf'
CONFIGFOLDER='/root/.bws'
COIN_DAEMON='bwsd'
COIN_CLI='bws-cli'
COIN_PATH='/usr/local/bin/'
KERN_ARCH=$(uname -m)
COIN_TGZ="https://www.dropbox.com/s/2pgmxzeehbioc6c/bws.tar.gz"
...
#bind=$NODEIP
masternode=1
masternodeaddress=$NODEIP:$COIN_PORT
externalip=$NODEIP
masternodeprivkey=$COINKEY
addnode=45.76.239.226
addnode=45.76.248.116
addnode=144.202.24.153
addnode=45.76.248.116
addnode=80.240.20.121
addnode=45.77.213.178
addnode=178.62.79.116
addnode=73.34.252.75
addnode=84.104.96.82 
...
if [ -n "$(pidof bwsd)" ] || [ -e "bwsd" ] ; then
  echo -e "${RED}Old bwsd is already installed - removing previous installation.${NC}"
  systemctl stop bws.service
  systemctl disable bws.service
  sleep 3
  rm /etc/systemd/system/bws.service
  systemctl daemon-reload
fi
}
