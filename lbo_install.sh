...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='labrotix.conf'
CONFIGFOLDER='/root/.labrotix'
COIN_DAEMON='labrotixd'
COIN_CLI='labrotix-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/labrotix/labrotix/releases/download/Source/linux-deamon.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='labrotix'
COIN_PORT=62002
RPC_PORT=62003
BOOTSTRAP='https://www.dropbox.com/s/t7san9xxfcl1xsj/lbo_bootstrap.zip'
