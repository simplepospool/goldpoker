...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='projectcoin.conf'
CONFIGFOLDER='/root/.projectcoin'
COIN_DAEMON='projectcoind'
COIN_CLI='projectcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/projectcoincore/ProjectCoin/releases/download/v1.3.0.0/PRJ-unsigned-1.3.0.0-x86_64-pc-linux-gnu.zip'
