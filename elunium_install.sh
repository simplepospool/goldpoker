...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='elunium.conf'
CONFIGFOLDER='/root/.elunium'
COIN_DAEMON='eluniumd'
COIN_CLI='elunium-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/EluniumCoin/Elunium/releases/download/v1.0/Elunium_Daemon_Ubuntu16.04.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='elunium'
COIN_PORT=21500
RPC_PORT=21501
BOOTSTRAP='http://164.68.116.197/elunium-bootstrap.zip'
