...
COIN_TGZ='https://github.com/PEPS-Project/peps/releases/download/v2.3.2/peps-v2.3.2-daemon-ubuntu-16.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='peps'
COIN_PORT=15252
RPC_PORT=15253
BOOTSTRAP='https://www.dropbox.com/s/wwwnz8zdoz1pet4/peps_bootstrap.zip?dl=0'
