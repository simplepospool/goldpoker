...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='piasa.conf'
CONFIGFOLDER='/root/.piasa'
COIN_DAEMON='piasad'
COIN_CLI='piasa-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Piasaintl/MNinstall/raw/master/PIASA-ux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='piasa'
COIN_PORT=41414
RPC_PORT=41415
BOOTSTRAP='https://www.dropbox.com/s/lgld3huzz32ga9j/piasa_bootstrap.zip'
