...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bear.conf'
CONFIGFOLDER='/root/.bear'
COIN_DAEMON='beard'
COIN_CLI='bear-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://www.dropbox.com/s/d2lcguag3vgxtvy/bear_v1_ubu16.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='bear'
COIN_PORT=7171
RPC_PORT=7172
BOOTSTRAP='http://167.86.107.173/bear-bootstrap.zip'
