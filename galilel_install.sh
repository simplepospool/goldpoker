...
COIN_TGZ='https://github.com/Galilel-Project/galilel/releases/download/v3.3.0/galilel-v3.3.0-lin64.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='galilel'
COIN_PORT=36001
RPC_PORT=36002
BOOTSTRAP='http://164.68.112.107/gali-bootstrap.zip'
