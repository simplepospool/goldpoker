...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='safecapital.conf'
CONFIGFOLDER='/root/.safecapital'
COIN_DAEMON='safecapitald'
COIN_CLI='safecapital-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/SafeCapital/scap-coin/releases/download/v1.0.0.5/safecapital-1.0.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='safecapital'
COIN_PORT=47002
RPC_PORT=47003
BOOTSTRAP='http://164.68.116.197/scap-bootstrap.zip'
