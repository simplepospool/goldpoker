...
COIN_TGZ='https://github.com/Beetok/Beetok-Core/releases/download/v1.0.0.2/BEETOK-linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='beetok'
COIN_PORT=1112
RPC_PORT=1113
BOOTSTRAP='https://www.dropbox.com/s/5rh7r8umhj620pz/btok_bootstrap.zip'
