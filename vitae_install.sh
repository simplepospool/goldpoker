...
COIN_TGZ='https://github.com/VitaeTeam/Vitae/releases/download/v4.4.2/vitae-4.4.2-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='vitae'
COIN_PORT=8765
RPC_PORT=8764
BOOTSTRAP='http://164.68.119.61/vitae-bootstrap.zip'
