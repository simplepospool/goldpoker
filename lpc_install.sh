...
COIN_DAEMON='lightpaycoind'
COIN_CLI='lightpaycoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/lpcproject/LightPayCoin/releases/download/v1.0.1.0/lightpaycoin-1.0.1-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='lightpaycoin'
COIN_PORT=39797
RPC_PORT=39798
BOOTSTRAP='https://www.dropbox.com/s/sx678su1aw20rng/lpc_bootstrap.zip'
